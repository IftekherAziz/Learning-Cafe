      ...
      <div className="bookmarks p-sm-2 p-md-3">
        ...
        <div className="bookmarks-blogs row row-col-1 gap-2 mx-1">
          {blogTitles.map((blogTitle, index) => {
            return (
              <div
                className="blogs-title d-flex justify-content-center align-items-center"
                key={index}
              >
